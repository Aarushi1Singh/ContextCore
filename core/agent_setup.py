...
def setup_chat_agent() -> FunctionAgent:
    ...
    return FunctionAgent(
        ...
        system_prompt=(
            ...
            "Step 1: Check if the provided research/graph context directly answers the question.\n\n"
            "Step 2: If it does NOT, and the question is about finance, macroeconomics, "
            "or technology, you MUST immediately call search_live_news or search_wikipedia "
            "to find the answer before responding. This is not optional. Never respond with "
            "phrases like 'the research does not contain' or 'I cannot provide' without "
            "FIRST attempting a search.\n\n"
            "Only skip searching if the question is clearly outside finance/tech/macro "
            "(e.g. sports, entertainment, personal advice).\n\n"
